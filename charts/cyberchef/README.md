...
Helm chart for deploying [cyberchef](https://github.com/gchq/CyberChef).

This chart is not maintained by the upstream project and any issues with the chart should be raised [here](https://github.com/Wu-Wu/charts/issues/new).
...
helm repo update
helm install cyberchef wu-wu/cyberchef
```
...
| ------------------ | --------------------------------------------- | ----- |
| `replicaCount`     | Number of replicas of the cyberchef Deployment | `1`   |
...
| Name               | Description                                                      | Value                         |
| ------------------ | ---------------------------------------------------------------- | ----------------------------- |
| `image.repository` | Container image repository                                       | `ghcr.io/gchq/cyberchef` |
...
| `metrics.image.tag`                                | Overrides the metrics image tag           | `"1.5.1"`                                                  |
